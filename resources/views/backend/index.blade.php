					...
					<div class="col-xl-3 col-xxl-6 col-lg-6 col-sm-6">
						<div class="card overflow-hidden">
							<div class="card-header border-0 pb-0">
								...
								<img src="{{ asset('backend')}}/images/svg/bitcoin-1.svg" alt="">
							</div>
					...
					<div class="col-xl-3 col-xxl-6 col-lg-6 col-sm-6">
						<div class="card overflow-hidden">
							<div class="card-header border-0 pb-0">
								...
								<img src="{{ asset('backend')}}/images/svg/ethereum-1.svg" alt="">
							</div>
							<div class="card-body p-0">
					...
					<div class="col-xl-3 col-xxl-6 col-lg-6 col-sm-6">
						<div class="card overflow-hidden">
							<div class="card-header border-0 pb-0">
								...
								<img src="{{ asset('backend')}}/images/svg/ripple-1.svg" alt="">
							</div>
							<div class="card-body p-0">
					...
					<div class="col-xl-3 col-xxl-6 col-lg-6 col-sm-6">
						<div class="card overflow-hidden">
							<div class="card-header border-0 pb-0">
								...
								<img src="{{ asset('backend')}}/images/svg/litecoin-1.svg" alt="">
							</div>
							<div class="card-body p-0">
						...
						<div class="card">
							...
							<div class="card-body">
								<div class="owl-bank-wallet owl-carousel owl-loaded owl-drag mb-4">
									<div class="items">
										<img class="mw-100" src="{{ asset('backend')}}/images/card/card1.jpg" alt="">
									</div>
									<div class="items">
										<img  class="mw-100" src="{{ asset('backend')}}/images/card/card2.jpg" alt="">
									</div>
									<div class="items">
										<img  class="mw-100" src="{{ asset('backend')}}/images/card/card3.jpg" alt="">
									</div>
								</div>
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<div class="testimonial-one owl-right-nav owl-carousel owl-loaded owl-drag">
									<div class="items">
										<div>
											<img class="mb-3" src="{{ asset('backend')}}/images/profile/10.jpg" alt="">
									...
									<div class="items">
										<div>
											<img class="mb-3" src="{{ asset('backend')}}/images/profile/11.jpg" alt="">
									...
									<div class="items">
										<div>
											<img class="mb-3" src="{{ asset('backend')}}/images/profile/12.jpg" alt="">
									...
									<div class="items">
										<div>
											<img class="mb-3" src="{{ asset('backend')}}/images/profile/13.jpg" alt="">
									...
									<div class="items">
										<div>
											<img class="mb-3" src="{{ asset('backend')}}/images/profile/14.jpg" alt="">
									...
									<div class="items">
										<div>
											<img class="mb-3" src="{{ asset('backend')}}/images/profile/15.jpg" alt="">
